...
function of_recognized_background_repeat() {
    $default = array(
        'no-repeat' => __( '不重复', 'mlldxe' ),
        'repeat-x'  => __( '水平重复', 'mlldxe' ),
        'repeat-y'  => __( '垂直重复', 'mlldxe' ),
        'repeat'    => __( '全部重复', 'mlldxe' ),
        );
    return apply_filters( 'of_recognized_background_repeat', $default );
}
function of_recognized_background_position() {
    $default = array(
        'top left'      => __( '上部左边', 'mlldxe' ),
        'top center'    => __( '上部中间', 'mlldxe' ),
        'top right'     => __( '上部右边', 'mlldxe' ),
        'center left'   => __( '中部左边', 'mlldxe' ),
        'center center' => __( '中部中间', 'mlldxe' ),
        'center right'  => __( '中部右边', 'mlldxe' ),
        'bottom left'   => __( '下部左边', 'mlldxe' ),
        'bottom center' => __( '下部中间', 'mlldxe' ),
        'bottom right'  => __( '下部右边', 'mlldxe')
        );
    return apply_filters( 'of_recognized_background_position', $default );
}
function of_recognized_background_attachment() {
    $default = array(
        'scroll' => __( '正常滚动', 'mlldxe' ),
        'fixed'  => __( '固定', 'mlldxe')
        );
